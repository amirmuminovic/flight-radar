...
def test_should_serialize_get_historic_flight_positions_light_request_correctly(
    mock_get_historic_flight_positions_light_response,
):
    session = MagicMock()
    mock_response = MagicMock()
    mock_response.status_code = 200
    mock_response.json.return_value = mock_get_historic_flight_positions_light_response
    ...
    service.get_historic_positions_light(request)
    ...
    assert url == 'https://api.flightradar24.com/historic/flight-positions/light'
...
def test_should_parse_get_historical_flight_positions_light_response_correctly(
    mock_get_historic_flight_positions_light_response,
):
    session = MagicMock()
    mock_response = MagicMock()
    ...
    response = service.get_historic_positions_light(request)
