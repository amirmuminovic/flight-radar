...
def test_should_pass_iata_code_correctly_get_airports_light(
    ...
    service.get_airports_light('ARN')

    session.get.assert_called_once()
    call_args = session.get.call_args
    url = call_args[0][0]
    assert url == 'https://api.flightradar24.com/static/airports/ARN/light'
