...
def test_should_serialize_get_flight_positions_request_correctly(
    mock_get_flight_positions_response,
):
    session = MagicMock()
    mock_response = MagicMock()
    mock_response.status_code = 200
    mock_response.json.return_value = mock_get_flight_positions_response
    ...
    service.get_live_flight_positions(request)
    ...
    assert url == 'https://api.flightradar24.com/live/flight-positions/full'
...
def test_should_parse_get_flight_positions_response_correctly(
    mock_get_flight_positions_response,
):
    session = MagicMock()
    mock_response = MagicMock()
